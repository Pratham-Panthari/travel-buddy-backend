      ...
      <Layout>

        {
          ...
          <div className='flex items-center justify-center absolute top-[200px] left-0 w-[100%]  mx-auto z-20' >
            <div className='bg-white px-6 py-6 w-[75%] rounded-md shadow-lg shadow-gray-500/50 '>
              {
                roomList.map(room => 
                    <div key={room._id} className='border-4 px-2 py-2 mb-2'>
                      <div className='flex'>
                        ...
                        <div className='px-2 py-2 w-[35%]'>
                          <h1 className='text-lg text-black font-semibold'>Select Room Number: </h1>
                          <div className='flex'>
                          {
                            room.roomNumbers.map(r => 
                                <div key={r._id} className='ml-2 '>
                                  <label className='text-lg text-black font-semibold mr-2 diabled:opacity-50'>{r.number}</label>
                          ...
                          <div className='mt-4'>
                            <button className='px-2 py-2 bg-blue-800 text-white text-md font-bold hover:bg-blue-900 rounded-xl' onClick={() =>{handleClick(); handleReservation()}}>Reserve Room</button>
                          </div>
                        </div>
